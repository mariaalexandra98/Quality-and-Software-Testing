...
public class Avion  {
	...
	public Avion(float greutateaIncarcata, String model, float capacitate) throws ExceptieConstructorAvion {
		if(model == null) {
			throw new ExceptieConstructorAvion("nul");
		}
	...
	public void setGreutateIncarcata(float greutateaIncarcata) throws ExceptieGreutateIncarcata {
		if(greutateaIncarcata >= 0 && greutateaIncarcata <= 1000) {
			this.greutateaIncarcata = greutateaIncarcata;
		}else{
			throw new ExceptieGreutateIncarcata("Greutatea inafar limitelor admise");
		}
	}
