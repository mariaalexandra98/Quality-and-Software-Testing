...
public class Avion  {
	...
	public void setGreutateIncarcata(float greutateaIncarcata) throws ExceptieValoareNeconforma {

		if(greutateaIncarcata >= 0 && greutateaIncarcata <= 1000) {
			this.greutateaIncarcata = greutateaIncarcata;
		} else{
			throw new ExceptieValoareNeconforma("Eroare greutate");
		}
	}
