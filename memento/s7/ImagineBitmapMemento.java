...
public class ImagineBitmapMemento extends ImagineBitmap{
    public ImagineBitmapMemento(int latime, int lungime, String schemaCulori, float dimensiune) {
    ...
    public void afisareImagine() {
        System.out.println("Afisare imagine: latime: " + latime + " lungime: " + lungime +
                " schema culori: " + schemaCulori + " dimensiune " + dimensiune);
